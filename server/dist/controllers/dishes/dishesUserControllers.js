...
export async function handleCategoryWithDishes(req, res) {
    try {
...
export async function handleAllCategories(req, res) {
    try {
...
export async function handleGetDishByUuid(req, res) {
    try {
...
export async function handleDishCommentsByUuid(req, res) {
    try {
...
export async function handleAddCommentByUuidDishes(req, res) {
    try {
...
export async function handleDeleteCommentByUuidDishes(req, res) {
    try {
