...
route.put("/status/:id", authenticateToken, authorizeAdmin, validate({ params: ordersSchemas.updateStatus.params, body: ordersSchemas.updateStatus.body }), handleUpdateStatusOrder)
route.delete("/deleteOrder/:id", authenticateToken, authorizeAdmin, validate({ params: ordersSchemas.deleteOrder.params }), handleDeleteOrderById)
